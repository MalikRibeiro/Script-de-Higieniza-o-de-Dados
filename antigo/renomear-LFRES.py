...
pasta = r'C:\Users\malik.mourad\Downloads\LFRES001_2025_09_LIQUIDACAO_ENERGIA_DE_RESERVA'
sufixo = 'LFRES001_set_25'

# Loop para renomear os arquivos PDF
for nome_arquivo in os.listdir(pasta):
    if nome_arquivo.endswith('.pdf'):
        caminho_antigo = os.path.join(pasta, nome_arquivo)

        # Remove prefixo "LFRES001_Liquidacao_de_Penalidades_"
